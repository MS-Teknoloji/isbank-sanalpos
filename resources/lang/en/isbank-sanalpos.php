...
return [
    ...
    'instructions' => [
        ...
        'sandbox_note' => 'Sandbox mode uses the Asseco shared test gateway (https://entegrasyon.asseco-see.com.tr/fim/est3Dgate). Production uses https://sanalpos.isbank.com.tr/fim/est3Dgate. Your Isbank production credentials will not work in sandbox — you need separate test credentials.',
